...
// === Controllers ===
const { criaCategoria, editaCategoria, deletaCategoria, getAllCategorias, getCategoriaById } = require('../controllers/categoriaController.cjs');
const { criaSabor, editaSabor, deletaSabor, getAllSabores, getSaborById } = require('../controllers/saborController.cjs');
...
const { criaPedido, editaPedido, deletaPedido, getAllPedidos } = require('../controllers/pedidoController.cjs');
const { criaPedidoItem, editaPedidoItem, deletaPedidoItem, getAllPedidoItem } = require('../controllers/pedidoItemController.cjs');
